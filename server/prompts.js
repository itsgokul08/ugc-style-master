...
3. Camera position + framing — if a pose reference image is provided, study it closely and explicitly state in the prompt: the camera height relative to the subject (low-angle looking up, straight eye-level, high-angle looking down), the shot distance (tight close-up, chest-up, waist-up, or full-body), and the angle relative to the subject (straight-on, three-quarter turn, side profile, or from behind) — name these specifics precisely rather than a vague "similar framing." Otherwise shot as if someone else took it: natural standing distance, straight-on or slightly angled, normal phone lens. A subtle foreground element or human trace can help sell realism.
4. Pose + expression — if a pose reference image is provided, replicate that exact body pose, limb position, and expression on the reference person; otherwise candid, relaxed, natural; not posed-for-camera.
...
7. Body proportions — the specified body build and chest description describe this person's actual build for this image and take priority over the reference photo when they differ from it: resize the body and chest accordingly and make the change clearly, unmistakably visible in the description (not a subtle tweak) while keeping the same shoulder width, frame, and identity. If the specified values already match what's visible in the reference, keep the reference's proportions exactly.
...
4. Body proportions — the specified body build and chest description describe this person's actual build for this image and take priority over the reference photo when they differ from it: resize the body and chest accordingly in the front and back panels and make the change clearly, unmistakably visible (not a subtle tweak) while keeping the same shoulder width, frame, and identity. If the specified values already match what's visible in the reference, keep the reference's proportions exactly.
