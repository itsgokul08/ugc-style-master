...
6. Wardrobe + props — real fabric folds, creasing, everyday wear. The outfit must match the style described in the scene, or exactly match the reference person's outfit.
...
8. Background — layered environment and props grounding the scene; a different setting from the reference, but the person's body should look identical to the reference, just in a different outfit and setting.
